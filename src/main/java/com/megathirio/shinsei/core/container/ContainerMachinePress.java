...
public class ContainerMachinePress extends Container {
	...
	public ContainerMachinePress(InventoryPlayer invPlayer, World world, int x, int y, int z){
	...
	public void onCraftMatrixChanged(IInventory iinventory){
		...
		craftResult.setInventorySlotContents(0, MachinePressCraftingManager.getInstance().findMatchingRecipe(craftMatrix, worldObj));
	}
	
	@Override
	public boolean canInteractWith(EntityPlayer player) {

		if(worldObj.getBlock(posX, posY, posZ) != ShinseiMachines.blockMachinePress){
			return false;
		}else{
