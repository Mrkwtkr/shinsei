...
//        return new TileEntityPressureFurnace();
    ...
    public static void updatePressureFurnaceBlockState(boolean isForging, World world, int xCoord, int yCoord, int zCoord) {
        ...
        if(isForging){
            world.setBlock(xCoord, yCoord, zCoord, ShinseiMachines.blockPressureFurnaceActi);
        }else{
            world.setBlock(xCoord, yCoord, zCoord, ShinseiMachines.blockPressureFurnaceIdle);
        }
