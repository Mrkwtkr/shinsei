...
public class ForgeFurnace extends BlockContainer{
    ...
    public Item getItemDropped(int i, Random random, int j){
        ...
        return Item.getItemFromBlock(ShinseiMachines.blockForgeFurnaceIdle);
    }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityPlayer, ItemStack itemstack){
		...
		if(itemstack.hasDisplayName()){
            ((TileEntityForgeFurnace)world.getTileEntity(x, y, z)).setGuiDisplayName(itemstack.getDisplayName());
        }
	}

    public static void updateForgeFurnaceBlockState(boolean isForging, World world, int xCoord, int yCoord, int zCoord) {
    ...
    public void breakBlock(World world, int x, int y, int z, Block oldBlock, int oldMetadata){
        ...
        if(!keepInventory){
            TileEntityForgeFurnace tileEntity = (TileEntityForgeFurnace) world.getTileEntity(x, y, z);
