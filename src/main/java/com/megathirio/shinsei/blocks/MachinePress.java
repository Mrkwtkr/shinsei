...
public class MachinePress extends BlockContainer{
	...
	public MachinePress(Material material) {
		super(material);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int q, float a, float b, float c){
		...
		if(!player.isSneaking()){
			...
			player.openGui(Main.instance, ShinseiMachines.guiIDMachinePress, world, x, y, z);
			return true;
		}else{
			return false;
		}
...
/*		if(itemstack.hasDisplayName()) {
			((TileEntityMachinePress)world.getTileEntity(x, y, z)).setGuiDisplayName(itemstack.getDisplayName());
		}*/
