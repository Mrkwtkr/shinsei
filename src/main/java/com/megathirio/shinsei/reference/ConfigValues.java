...
public class ConfigValues {
    //Tools
    public static boolean booToolValue = false;

    //Minerals
    public static boolean booBasaltValue = true;
    public static boolean booChalkValue = true;
    ...
    //Ores
    public static boolean booAluminumValue = true;
