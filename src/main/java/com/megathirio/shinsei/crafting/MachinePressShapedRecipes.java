...
public class MachinePressShapedRecipes implements IRecipe
{
    ...
    public MachinePressShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    public MachinePressShapedRecipes func_92100_c()
    {
